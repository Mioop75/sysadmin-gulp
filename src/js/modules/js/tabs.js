export default class Tabs {
  constructor(selector, options) {
    ...
    if (this.tabs) {
      ...
      this.tabsBtns = this.tabList.querySelectorAll(".tabs-list__btn")
  ...
  init() {
    ...
    this.tabsBtns.forEach((el, i) => {
      ...
      el.classList.remove("tabs-list__btn--active")
    })
    ...
    this.tabsBtns[0].classList.add('tabs-list__btn--active')
  ...
  switchTabs(newTab, oldTab = this.tabs.querySelector('[aria-selected]')) {
    ...
    this.tabsBtns[oldIndex].classList.remove("tabs-list__btn--active")
    this.tabsBtns[index].classList.add("tabs-list__btn--active")
